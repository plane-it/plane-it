  ...
  fetch("/registros/buscarEstadoServidores", {
    ...
    .then((res) => {
      if (res.error) {
        ...
        porcentServidoresRisco.innerHTML =
          ((servidoresRisco / totalServidores) * 100).toFixed(2) + "%";
        porcentServidoresAlerta.innerHTML =
          ((servidoresAlerta / totalServidores) * 100).toFixed(2) + "%";
